/*
  ...
  - A unique constraint covering the columns `[name,branchId,semesterId]` on the table `Subject` will be added. If there are existing duplicate values, this will fail.
