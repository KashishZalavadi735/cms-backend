...
-- AlterTable
ALTER TABLE `user` ADD COLUMN `statusId` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `User` ADD CONSTRAINT `User_statusId_fkey` FOREIGN KEY (`statusId`) REFERENCES `EnumTable`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
